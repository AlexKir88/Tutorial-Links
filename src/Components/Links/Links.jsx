...
import {addDefoultData, inputLinkService, pushLinkService, pushGroupServise, deleteGroupSetrvise, clikLink, goToService} from '../../servise/linksDataFunctions';
...
const Links = ({groups, setGroups, language, dispatch}) => {
    ...
    const deleteGroup = (name) => deleteGroupSetrvise(name, setGroups);
    const goTo = (e, url) => goToService(e, url);
